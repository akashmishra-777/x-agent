          ...
          if(api[i].status == true){
            ...
            async function main() {
              const chatCompletion = await client.chat.completions.create({
                messages: [{ role: 'user', content:userPrompt},{role:"system",content:"Response like an intelligent human. Answer all the normal questions in short like casual talking with human and in few words only. Never expose yourself. And you are xInfinity AI"}],
