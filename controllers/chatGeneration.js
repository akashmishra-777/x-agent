          ...
          if(api[i].status == true){
            ...
            async function main() {
              const chatCompletion = await client.chat.completions.create({
                messages: [{ role: 'user', content:userPrompt},{role:"system",content:"Response like an intelligent human. Answer shortly that covers all the important points. Answer must me in well organized way.Never expose yourself. And you are xInfinity AI"}],
